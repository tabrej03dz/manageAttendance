    ...
    <div class="app-container">
        ...
        <!-- =======================
            *** Main/Hero Section *** 2xl:max-w-full
            ======================== -->
        <main class=" bg-heroGradient z-50  relative">
            <div
        ...
        <section class="w-full xl:max-w-7xl mx-auto py-16 px-6 md:px-16  2xl:px-0">
            <marquee behavior="scroll-smooth" direction="ltr">
                <div class="slide gap-8 *:cursor-pointer flex justify-center items-center xl:justify-between">
                    <img src="{{ asset('mainasset/img/brandImgs/img-1.jpg') }}" loading="lazy" alt="brand">
                    <img src="{{ asset('mainasset/img/brandImgs/img-2.jpg') }}" loading="lazy" alt="brand">
                    <img src="{{ asset('mainasset/img/brandImgs/img-3.jpg') }}" loading="lazy" alt="brand">
                    <img src="{{ asset('mainasset/img/brandImgs/img-4.jpg') }}" loading="lazy" alt="brand">
                    <img src="{{ asset('mainasset/img/brandImgs/img-5.jpg') }}" loading="lazy" alt="brand">
                    <img src="{{ asset('mainasset/img/brandImgs/img-1.jpg') }}" loading="lazy" alt="brand">
                    <img src="{{ asset('mainasset/img/brandImgs/img-2.jpg') }}" loading="lazy" alt="brand">
                    <img src="{{ asset('mainasset/img/brandImgs/img-3.jpg') }}" loading="lazy" alt="brand">
                    <img src="{{ asset('mainasset/img/brandImgs/img-4.jpg') }}" loading="lazy" alt="brand">
        ...
        <section id="attendNow" class="aboutBG  relative">
            ...
            <div
                ...
                <div class="block md:place-items-end xl:place-items-start">
                    <h1
                        ...
                        Reinventing <strong class="text-bgSecondary font-futuraMd font-bold">Employee Attendance</strong>
                        with
                        Location Tracking
          ...
          w-full h-auto sm:w-[550px] md:w-[600px] md:ml-12 overflow-auto">
                        With GPS technology, employers can track their employees in real-time, identify their location,
                        monitor
                        their movement, and track their arrival and departure times from any location. GPS technology can
                        also be
                        used to generate automatic attendance records, determine if employees are taking the most effective
                        route
                        to
                        their destination, and ensure their safety while on the job. AttendNow provides all of the above
                        even when
                        the users have poor or no network and integrates with payroll and leave management.
                    </p>
                </div>
            </div>
        ...
        <!-- =======================
            ***  Reviews Section ***
            ======================== -->
        <section id="review" class="relavtive py-24 ">
        ...
        <!-- shape 1 -->
        <div class="custom-shape-divider-top-1732633376">
            <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120"
                preserveAspectRatio="none">
                <path
                    d="M0,0V46.29c47.79,22.2,103.59,32.17,158,28,70.36-5.37,136.33-33.31,206.8-37.5C438.64,32.43,512.34,53.67,583,72.05c69.27,18,138.3,24.88,209.4,13.08,36.15-6,69.85-17.84,104.45-29.34C989.49,25,1113-14.29,1200,52.47V0Z"
        ...
        <!-- =======================
            ***  Price Section ***
            ======================== -->
        <section id="price" class="bg-white py-24">
            <div class="justify-items-center w-full xl:max-w-7xl mx-auto py-16 px-6 md:px-16 ">
                ...
                <div
                    ...
                    <!-- car1 -->
                    <div
                        class="box-1 bg-white w-full max-w-[375px] h-max mx-auto px-4 py-10 border-[1px] border-gray-200 font-futuraMd text-gray-500 rounded-2xl">
        ...
        <!-- shape 2  -->
        <div class="custom-shape-divider-bottom-1732633459">
            <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120"
                preserveAspectRatio="none">
                <path
