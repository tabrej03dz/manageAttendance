...
@section('content')
    ...
    <div class="container p-4" id="contentToPrint">
        <div class="row mb-2">
            <table class="table table-bordered text-center">
                <thead>
                <tr>
                    <th colspan="2" class="text-center">
                        <h3 class="m-0">X-MEN SECURITY AGENCY</h3>
                    </th>
                </tr>
                </thead>
                <tbody>
                <tr>
                    <td colspan="2">
                        Harsh Nagar, Mahanandpur Near Indira Garden<br>
    ...
    <button id="downloadPdf" class="btn btn-primary" onclick="printDivAsPDF()" >Download Salary Slip</button>
