        ...
        <div class="content">
            <div class="container-fluid">
                <div class="card shadow-lg border-danger rounded-3">
                    ...
                    <div class="card-body">
                        <form action="{{ route('correctionNote.store', ['record' => $record->id, 'note' => $note ? $note->id : '']) }}" method="POST" >
                            @csrf
                            <div class="row mb-4">
                                <div class="col-md-6">
                                    ...
                                    <textarea name="note" class="form-control" id="note" rows="2" placeholder="Enter your full note">{{ old('note') }}</textarea>
                                </div>
