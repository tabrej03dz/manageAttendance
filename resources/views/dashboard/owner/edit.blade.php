        ...
        <div class="content">
            <div class="container-fluid">
                <div class="card shadow-lg border-danger rounded-3">
                    ...
                    <div class="card-body">
                        <form action="{{ route('owner.update', ['owner' => $owner->id]) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea name="address" class="form-control" id="address" rows="2">{{$owner->address}}</textarea>
                                </div>
                            </div>
