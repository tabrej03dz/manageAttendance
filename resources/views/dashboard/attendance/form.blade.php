        ...
        <main class="flex-grow flex flex-col items-center justify-center p-4">
            ...
            <div class="w-full max-w-xs">
                ...
                <form
                    ...
                    <div class="d-grid">
                        <button type="submit" id="upload" class="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-3 md:py-3 md:px-4 rounded-full w-full mb-3 flex items-center justify-center">Submit</button>
                    </div>
                </form>
