    ...
    <section class="content">
        <div class="container-fluid">
            ...
            @forelse($activities as $activity)
                @php
                    $activeSeconds = (int) ($activity->active_seconds ?? 0);
                    ...
                    $lastSeenAt = $activity->last_seen_at
                        ? \Carbon\Carbon::parse($activity->last_seen_at)
                        : null;

                    $startedAt = $activity->started_at
                        ? \Carbon\Carbon::parse($activity->started_at)
                        : null;
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-2 col-md-4 col-6 mb-3">
                                ...
                                <strong>
                                    {{ number_format($activity->page_views ?? 0) }}
                                </strong>
                            </div>
                            ...
                            <div class="col-xl-2 col-md-4 col-6 mb-3">
                                ...
                                <strong>
                                    {{ ucfirst($activity->device_type ?: 'Unknown') }}
                                </strong>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <strong>
                                    {{
                                        $startedAt
                                            ? $startedAt->format('d M Y, h:i:s A')
                                            : '-'
                                    }}
                                </strong>
                            </div>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <strong>
                                    {{
                                        $lastSeenAt
                                            ? $lastSeenAt->format('d M Y, h:i:s A')
                                            : '-'
                                    }}
                                </strong>
                            ...
                            <table class="table table-hover table-bordered mb-0">
                                ...
                                <tbody>
                                    @forelse($activity->pages as $page)
                                        @php
                                            $pageSeconds = (int) ($page->active_seconds ?? 0);
