                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div
                                                class="rounded-circle bg-light border d-flex align-items-center justify-content-center mr-2 flex-shrink-0"
                                    ...
                                    <td>
                                        @if($lastSeenAt)
                                            <span
                                                title="{{ $lastSeenAt->format('d M Y, h:i:s A') }}"
                                            >
