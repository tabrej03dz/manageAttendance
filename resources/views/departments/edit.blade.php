...
<style>
    ...
    .department-current-name {
        ...
        border-radius: 999px;
        background: rgba(67, 56, 202, 0.50);
        color: #ffffff;
        padding: 7px 12px;
        font-size: 12px;
        font-weight: 700;
    ...
    <section class="department-form-hero p-6 sm:p-8">
        ...
        <div class="relative">
            ...
            <div class="flex flex-wrap items-center gap-2">
                ...
                <span class="department-current-name">
            ...
            <p class="mt-3 max-w-2xl text-sm font-medium leading-6 text-blue-100 sm:text-base">
                Existing department की information update करें।
            </p>
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm font-medium text-slate-500">
                        Department name में आवश्यक बदलाव करें।
                    </p>
                </div>
            </div>
        </div>
        ...
        <form action="{{ route('departments.update', $department->id) }}"
            ...
            <div>
                ...
                <p class="mt-2 text-xs font-medium text-slate-500">
                    Department का updated नाम save करने के लिए Update button दबाएं।
                </p>
            </div>
